...
int main() {
    ...
    cout << "Forward Float \%error: " << setprecision(10) << abs(((e_float - e) / e)) * (100) << endl; 

    for (int i = 99; i >= 0; i--){
        e_float_backward = e_float_backward + e_nums_float[i];
    }
    cout << "Backward Float Approx: " << setprecision(10) << e_float_backward << endl;
    cout << "Backward Float \%error = " << setprecision(10) << abs(((e_float_backward - e) / e)) * (100)<< endl; 
    cout << "-----" << endl; 
    ...
    cout << "Forward Double \%error: " << setprecision(10) << abs(((e_double - e) / e)) * (100) << endl; 

    for (int i = 99; i >= 0; i--){
        e_double_backward = e_double_backward + e_nums_double[i]; 
    } 
    cout << "Backward Double Approx: " << setprecision(10) << e_double_backward << endl; 
    cout << "Backward Double \%error: " << setprecision(10) << abs(((e_double_backward - e) / e)) * (100) << endl;
    cout << "-----" << endl;  
